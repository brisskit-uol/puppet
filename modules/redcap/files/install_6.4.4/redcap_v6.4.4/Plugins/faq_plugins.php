...
<h2 id="WhywouldsomeonebuildaREDCapplugin">Why would someone build a REDCap plugin?<a class="anchor" href="#WhywouldsomeonebuildaREDCapplugin" title="Link to this section"></a></h2>
<p>
A REDCap plugin can be built for a variety of reasons. It may be to build a custom PHP page that simply piggybacks REDCap's authentication (if your plugin's users would also be REDCap users), thus preventing one from having to construct their own web application's method of authentication from scratch. Also, it could be used just for connecting to and querying REDCap's database tables in a quick and easy fashion. Of course, the major advantage of having a REDCap plugin is that you can construct it such that it can be utilized in REDCap as if it were an official module or page within REDCap proper. Such could be accomplished in tandem with the Project Bookmarks functionality, which allows you to create a link to your plugin on a REDCap project's left-hand menu to allow easy navigation between that project and your plugin, thus making creating seamless navigation to and from your plugin.
</p>

<h2 id="HowarepluginsaccessedinREDCap">How are plugins accessed in REDCap?<a class="anchor" href="#HowarepluginsaccessedinREDCap " title="Link to this section"></a></h2>
<p>
...
<h2 id="WhocanbuildaREDCapplugin">Who can build a REDCap plugin?<a class="anchor" href="#WhocanbuildaREDCapplugin" title="Link to this section"></a></h2>
<p>
...
<h2 id="WhocanuseaREDCapplugin">Who can use a REDCap plugin?<a class="anchor" href="#WhocanuseaREDCapplugin" title="Link to this section"></a></h2>
<p>
...
<h2 id="Howdoesonecalltheredcap_connect.phpfile">How does one call the redcap_connect.php file?<a class="anchor" href="#Howdoesonecalltheredcap_connect.phpfile" title="Link to this section"></a></h2>
<p>
...
If redcap_connect.php is not in that location, you can 
<strong><a href="https://iwg.devguard.com/trac/redcap/browser/misc/redcap_connect.zip?format=raw">download redcap_connect.php</a></strong> 
and then place it in that location.
</p>
<h2 id="WhereshouldmypluginfilesbelocatedontheREDCapwebserver">Where should my plugin file(s) be located on the REDCap web server?<a class="anchor" href="#WhereshouldmypluginfilesbelocatedontheREDCapwebserver" title="Link to this section"></a></h2>
<p>
...
<h2 id="Whatisthedifferencebetweenproject-levelandsystem-levelplugins">What is the difference between project-level and system-level plugins?<a class="anchor" href="#Whatisthedifferencebetweenproject-levelandsystem-levelplugins" title="Link to this section"></a></h2>
<p>
...
</span></pre></div><h2 id="Howtolimitpluginaccesstospecificprojectsandorspecificusers">How to limit plugin access to specific projects and/or specific users<a class="anchor" href="#Howtolimitpluginaccesstospecificprojectsandorspecificusers" title="Link to this section"></a></h2>
<p>
...
</pre></div><h2 id="HowdoesonebegincreatingaREDCapplugin">How does one begin creating a REDCap plugin?<a class="anchor" href="#HowdoesonebegincreatingaREDCapplugin" title="Link to this section"></a></h2>
<p>
...
<h2 id="WhatisthepreferredmethodinapluginforqueryingREDCapsdatabasetables">What is the preferred method in a plugin for querying REDCap's database tables?<a class="anchor" href="#WhatisthepreferredmethodinapluginforqueryingREDCapsdatabasetables" title="Link to this section"></a></h2>
<p>
...
<h2>Can I share my plugin with other REDCap partners?</h2>
<p>
Yes, we highly encourage plugin developers to share their plugins with other REDCap partners when applicable. There is a 
<a target="_blank" style="font-weight:bold;" href="https://iwg.devguard.com/trac/redcap/wiki/PluginLibrary">Plugin Library</a> 
page on the consortium wiki
where anyone with wiki access can upload their plugin to share. And as a plugin developer, you may also download
any of the plugins that have already been uploaded and shared on that page. If you do not have access to the 
consortium wiki, then someone from your institution most likely does, in which case they can request that you be given access
by filling out the <a target="_blank" style="font-weight:bold;" href="http://tinyurl.com/redcapsupport2">Request for Access to REDCap Consortium Support Tools survey</a>
for you.
</p>
...
<h1 id="PluginExamples">Plugin Examples<a class="anchor" href="#PluginExamples" title="Link to this section"></a></h1>
<p>
The "redcap_connect.php" file and plugin example files can be 
<strong><a href="https://iwg.devguard.com/trac/redcap/browser/misc/redcap_connect.zip?format=raw">downloaded here</a></strong> if you do not yet have them.
<br>
</p>
<h3 id="NOTE:Alltheexamplesbelowassumethatthepluginpageexistsinadirectorybelowtheredcap_connect.phpfile.">** NOTE: All the examples below assume that the plugin page exists in a directory below the redcap_connect.php file. **<a class="anchor" href="#NOTE:Alltheexamplesbelowassumethatthepluginpageexistsinadirectorybelowtheredcap_connect.phpfile." title="Link to this section"></a></h3>
<p>
<br>
</p>
<h2 id="Example1:SimpleplugintemplatewithnoREDCapheaderfooter">Example 1: Simple plugin template (with no REDCap header/footer)<a class="anchor" href="#Example1:SimpleplugintemplatewithnoREDCapheaderfooter" title="Link to this section"></a></h2>
<p>
...
</span></pre></div><h2 id="Example2:Pluginpagethatonlydisplaystheredcap_infotable">Example 2: Plugin page that only displays the redcap_info() table<a class="anchor" href="#Example2:Pluginpagethatonlydisplaystheredcap_infotable" title="Link to this section"></a></h2>
<div class="code"><pre><span class="cp">&lt;?php</span>
<span class="c">// Call the REDCap Connect file in the main "redcap" directory
</span><span class="k">require_once</span> <span class="s2">"../redcap_connect.php"</span><span class="p">;</span>
...
</pre></div><h2 id="Example3:SimpleplugintemplatedisplayingREDCapssystem-levelpageheaderfooter">Example 3: Simple plugin template displaying REDCap's system-level page header/footer<a class="anchor" href="#Example3:SimpleplugintemplatedisplayingREDCapssystem-levelpageheaderfooter" title="Link to this section"></a></h2>
<div class="code"><pre><span class="cp">&lt;?php</span>
<span class="c">// Call the REDCap Connect file in the main "redcap" directory
</span><span class="k">require_once</span> <span class="s2">"../redcap_connect.php"</span><span class="p">;</span>
...
</pre></div><h2 id="Example5:PluginthatqueriestheREDCapdatabase">Example 5: Plugin that queries the REDCap database<a class="anchor" href="#Example5:PluginthatqueriestheREDCapdatabase" title="Link to this section"></a></h2>
<div class="code"><pre><span class="cp">&lt;?php</span>
<span class="c">// Call the REDCap Connect file in the main "redcap" directory
</span><span class="k">require_once</span> <span class="s2">"../redcap_connect.php"</span><span class="p">;</span>
