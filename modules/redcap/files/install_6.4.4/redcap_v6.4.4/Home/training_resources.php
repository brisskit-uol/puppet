...
<table border=1 cellpadding=4 cellspacing=0 style='border-collapse:collapse;border:1px solid #888;width:100%;text-align:center;'>
	...
	<tr>
		<td class='bigTitle'>
			<?php echo $lang['training_res_90'] ?>
		</td>
		<td class='descrip'>
			<?php echo $lang['training_res_91'] ?>			
		</td>
		<td class='exvid'>
			<a onclick="popupvid('form_editor_upload_dd02.flv','Introduction to Project Development')" href="javascript:;" 
				style="font-size:12px;text-decoration:underline;"><img src='<?php echo APP_PATH_IMAGES ?>video.png'></a>
			<div style='color:#555;font-size:11px;'>4 <?php echo $lang['config_functions_72'] ?></div>
		</td>
	</tr>
	...
	<tr>
		...
		<td class='exvid'>
			<a onclick="popupvid('online_designer01.flv','The Online Designer')" href="javascript:;" 
				style="font-size:12px;text-decoration:underline;"><img src='<?php echo APP_PATH_IMAGES ?>video.png'></a>
...
<table border=1 cellpadding=4 cellspacing=0 style='border-collapse:collapse;border:1px solid #888;width:100%;text-align:center;'>
	...
	<tr>
		...
		<td class='exvid'>
			<a onclick="popupvid('redcap_db_applications_menu02.flv','<?php echo cleanHtml($lang['training_res_97']) ?>')" href="javascript:;" 
			   style="font-size:12px;text-decoration:underline;font-weight:normal;"><img src='<?php echo APP_PATH_IMAGES ?>video.png'></a>
	...
	<tr>
		...
		<td class='exvid'>
			<a onclick="popupvid('calendar02.flv','<?php echo cleanHtml($lang['bottom_33']) ?>')" href="javascript:;" 
			   style="font-size:12px;text-decoration:underline;font-weight:normal;"><img src='<?php echo APP_PATH_IMAGES ?>video.png'></a>
	...
	<tr>
		...
		<td class='exvid'>
			<a onclick="popupvid('scheduling02.flv','The REDCap Scheduling Module')" href="javascript:;" 
			   style="font-size:12px;text-decoration:underline;font-weight:normal;"><img src='<?php echo APP_PATH_IMAGES ?>video.png'></a>
			<div style='color:#555;font-size:11px;'>7 <?php echo $lang['config_functions_72'] ?></div>
		</td>
	</tr>
	<tr>
		...
		<td class='exvid'>
			<a onclick="popupvid('data_access_groups02.flv','Data Access Groups')" href="javascript:;" 
			   style="font-size:12px;text-decoration:underline;font-weight:normal;"><img src='<?php echo APP_PATH_IMAGES ?>video.png'></a>
			<div style='color:#555;font-size:11px;'>7 <?php echo $lang['config_functions_72'] ?></div>
		</td>
	</tr>
...
<table border=1 cellpadding=4 cellspacing=0 style='border-collapse:collapse;border:1px solid #888;width:100%;text-align:center;'>
	...
	<tr>
		...
		<td class='exvid'>
			<a onclick="popupvid('project_types01.flv','Types of REDCap Projects')" href="javascript:;" 
			   style="font-size:12px;text-decoration:underline;font-weight:normal;"><img src='<?php echo APP_PATH_IMAGES ?>video.png'></a>
	...
	<tr>
		...
		<td class='exvid'>
			<a onclick="popupvid('traditional_project02.flv','The Traditional REDCap Project')" href="javascript:;" 
			   style="font-size:12px;text-decoration:underline;font-weight:normal;"><img src='<?php echo APP_PATH_IMAGES ?>video.png'></a>
			<div style='color:#555;font-size:11px;'><?php echo $lang['training_res_33'] ?></div>
		</td>
	</tr>
	...
	<tr>
		...
		<td class='exvid'>
			<a onclick="popupvid('longitudinal_project02.flv','The Longitudinal REDCap Project')" href="javascript:;" 
			   style="font-size:12px;text-decoration:underline;font-weight:normal;"><img src='<?php echo APP_PATH_IMAGES ?>video.png'></a>
			<div style='color:#555;font-size:11px;'><?php echo $lang['training_res_33'] ?></div>
		</td>
	</tr>
	<tr>
		...
		<td class='exvid'>
			<a onclick="popupvid('longitudinal_sched_project02.flv','The Longitudinal REDCap Project with Scheduling')" href="javascript:;" 
			   style="font-size:12px;text-decoration:underline;font-weight:normal;"><img src='<?php echo APP_PATH_IMAGES ?>video.png'></a>
			<div style='color:#555;font-size:11px;'><?php echo $lang['training_res_33'] ?></div>
		</td>
	</tr>
	<tr>
		...
		<td class='exvid'>
			<a onclick="popupvid('operational_project02.flv','Using REDCap for Operational Use and Non-clinical Data Collection')" href="javascript:;" 
			   style="font-size:12px;text-decoration:underline;font-weight:normal;"><img src='<?php echo APP_PATH_IMAGES ?>video.png'></a>
...
<table border=1 cellpadding=4 cellspacing=0 style='border-collapse:collapse;border:1px solid #888;width:100%;text-align:center;'>
	...
	<tr>
		...
		<td class='exvid'>
			<a onclick="popupvid('define_events02.flv','<?php echo cleanHtml($lang['training_res_69']) ?>')" href="javascript:;" 
			   style="font-size:12px;text-decoration:underline;font-weight:normal;"><img src='<?php echo APP_PATH_IMAGES ?>video.png'></a>
			<div style='color:#555;font-size:11px;'>5 <?php echo $lang['config_functions_72'] ?></div>
		</td>
	</tr>
	...
	<tr>
		...
		<td class='exvid'>
			<a onclick="popupvid('designate_instruments02.flv','<?php echo cleanHtml($lang['training_res_79']) ?>')" href="javascript:;" 
			   style="font-size:12px;text-decoration:underline;font-weight:normal;"><img src='<?php echo APP_PATH_IMAGES ?>video.png'></a>
	...
	<tr>
		...
		<td class='exvid'>
			<a onclick="popupvid('locking02.flv','Record Locking Functionality')" href="javascript:;" 
			   style="font-size:12px;text-decoration:underline;font-weight:normal;"><img src='<?php echo APP_PATH_IMAGES ?>video.png'></a>
	...
	<tr>
		...
		<td class='exvid'>
			<a onclick="popupvid('data_resolution_workflow01.swf','<?php echo cleanHtml($lang['dataqueries_137']) ?>')" href="javascript:;" 
			   style="font-size:12px;text-decoration:underline;font-weight:normal;"><img src='<?php echo APP_PATH_IMAGES ?>video.png'></a>
			<div style='color:#555;font-size:11px;'>5 <?php echo $lang['config_functions_72'] ?></div>
		</td>
	</tr>
