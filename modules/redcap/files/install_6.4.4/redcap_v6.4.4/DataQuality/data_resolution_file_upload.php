...
// Give response
print "<script language='javascript' type='text/javascript'>
		window.parent.window.dataResolutionStopUpload('$doc_id','".cleanHtml($doc_name)."');
	   </script>";
...
log_event("","redcap_edocs_metadata","MANAGE",$_POST['record'],$logDataValues,"Upload document for data query response");
