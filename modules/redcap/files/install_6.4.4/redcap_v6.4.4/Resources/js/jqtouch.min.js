      ...
      submitHandler = (function(_this) {
        return function(e, callback) {
          ...
          if ($form.length && $form.is(_this.settings.formSelector) && $form.attr("action")) {
			// Rob Taylor (11/21/2014) - change to allow file uploads on data entry forms
			if ($form.attr("action").indexOf("DataEntry/file_upload.php?") > 0) return;
			// End of Rob Taylor edit
            e.preventDefault();
