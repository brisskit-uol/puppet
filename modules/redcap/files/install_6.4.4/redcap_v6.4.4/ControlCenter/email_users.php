...
print "<h3 id='email_users_header' style='margin-top: 0;'><img src='".APP_PATH_IMAGES."email_go.png' class='imgfix1'> {$lang['email_users_02']}</h3>";
...
print  '<form name="notify" id="email_form" method="post" action="email_users.php">
		...
		<table cellpadding="0" cellspacing="0" style="width:100%;padding:6px;padding-top:0px;"><tr>
		<td valign="top" align="left">
			...
			<tr>
				...
				<td style="vertical-align:middle;">
					<input type="text" class="x-form-text x-form-field" id="emailSubject" name="emailSubject" style="width:400px;" 
			...
			<tr>
				<td colspan="2"><textarea id="emailMessage" name="emailMessage" class="x-form-textarea x-form-field" 
					style="width:550px;height:120px;"></textarea></td>
			</tr>			
			<tr>
...
$htmlString =  '<table id="user_list_table" cellspacing="0" style="width:100%;border:1px solid #bbb;border-top:0;">
...
$sql = "select i.ui_id, trim(lower(i.username)) as username, i.user_firstname, i.user_lastname, i.user_email, 
		...
		where i.username != '' order by trim(lower(i.username))";
$q = db_query($sql);
$table_color = "#F5F5F5";
$id_uncheck = '';
$id_check   = '';
