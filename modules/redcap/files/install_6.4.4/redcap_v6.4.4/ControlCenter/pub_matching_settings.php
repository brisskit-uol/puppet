...
$html = '';
$html .= RCView::h3(array('style' => 'margin-top: 0;'),  RCView::img(array('src'=>'newspaper_arrow.png', 'class'=>'imgfix1')) . RCL::pubCtrlTitle());
	...
	function populateAuthorTags() {
		...
		$.ajax({url: ajaxScript,
			...
			success: function(data) {
				...
				$("#pub_author_search").ui_autocomplete({
					source: authorTags,
					delay: 0,
