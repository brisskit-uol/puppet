			...
			RCView::div(array('style'=>''),
				RCView::div(array('class'=>'hide_in_print', 'style'=>'float:left;width:350px;'), 
					...
					RCView::div(array('style'=>''), 
						...
						RCView::span(array('style'=>'margin-left:5px;'), User::number_format_user(Records::getCountRecordEventPairs())) .
						(!$longitudinal ? "" :
				...
				RCView::div(array('class'=>'hide_in_print', 'style'=>'float:left;'),
					...
					($_POST['report_id'] == 'ALL' || $_POST['report_id'] == 'SELECTED' || !$user_rights['reports'] ? '' :
						// Edit report link
						RCView::button(array('class'=>'report_btn jqbuttonmed', 'onclick'=>"window.location.href = '".APP_PATH_WEBROOT."DataExport/index.php?pid=".PROJECT_ID."&report_id={$_POST['report_id']}&addedit=1';", 'style'=>'font-size:11px;padding:1px 4px 0px !important;'),
