...
$saveSuccess = 	DataExport::doReport($_POST['report_id'], 'export', $outputFormat, false, $archiveFiles, $outputDags, $outputSurveyFields, 
							...
							RCView::tr(array(),
								RCView::td(array('valign'=>'top', 'class'=>'nowrap', 'style'=>'padding:10px 0 0 20px;'),
									...
									RCView::a(array('href'=>APP_PATH_WEBROOT."FileRepository/file_download.php?pid=$project_id&id=$data_edoc_id" .
										...
										trim(DataExport::getDownloadIcon(($syntax_edoc_id == null ? $outputFormat : ''), $dateShiftDates))
									) .
