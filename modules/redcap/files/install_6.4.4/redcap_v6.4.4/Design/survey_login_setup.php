...
if (isset($_POST['action']) && $_POST['action'] == 'view')
{
	...
	$content = 	RCView::div(array(),
					...
					RCView::div(array('style'=>'margin:0 0 10px;'),
						$lang['survey_592'] . " " .
						RCView::a(array('onclick'=>"$(this).hide();$('#survey-login-hidden-instructions').show();fitDialog($('#survey_login_setup_dialog'));$('#survey_login_setup_dialog').dialog('option', 'position', { my: 'center', at: 'center', of: window });", 
					...
					RCView::form(array('id'=>'survey_login_setup_form'),
						...
						RCView::table(array('cellspacing'=>0, 'class'=>'form_border', 'style'=>'width:100%;'),
							// Enabled?
							RCView::tr(array(),
								RCView::td(array('valign'=>'top', 'class'=>'label '.($survey_auth_enabled ? 'darkgreen' : 'red'), 'style'=>'padding:6px 10px;'),
									RCView::img(array('src'=>'key.png', 'class'=>'imgfix')) .
									RCView::b($lang['survey_616'])
								) .
								RCView::td(array('valign'=>'top', 'class'=>'data '.($survey_auth_enabled ? 'darkgreen' : 'red'), 'style'=>'padding:6px 10px;'),
									RCView::select(array('name'=>'survey_auth_enabled', 'onchange'=>"enableSurveyLoginRowColor();", 'class'=>'x-form-text x-form-field', 'style'=>'padding-right:0;height:22px;'), 
							...
							RCView::tr(array(),
								...
								RCView::td(array('valign'=>'top', 'class'=>'data', 'style'=>'padding:6px 10px;'),
									RCView::select(array('name'=>'survey_auth_field1', 'class'=>'survey-login-field x-form-text x-form-field', 'style'=>'width:300px;padding-right:0;height:22px;'), 
									...
									(!$longitudinal ? '' :
										RCView::div(array('style'=>'margin-top:4px;'),
											...
											RCView::select(array('name'=>'survey_auth_event_id1', 'class'=>'x-form-text x-form-field', 'style'=>'width:280px;padding-right:0;height:22px;'), 
							...
							RCView::tr(array('style'=>($survey_auth_field2 == '' ? 'display:none;' : '')),
								...
								RCView::td(array('valign'=>'top', 'class'=>'data', 'style'=>'padding:6px 10px;'),
									RCView::select(array('name'=>'survey_auth_field2', 'class'=>'survey-login-field x-form-text x-form-field', 'style'=>'width:300px;padding-right:0;height:22px;'), 
									...
									RCView::a(array('class'=>'survey_auth_field_delete', 'href'=>'javascript:;', 'style'=>'margin-left:5px;'.($survey_auth_field3 == '' ? '' : 'display:none;'), 'onclick'=>"removeSurveyLoginFieldInDialog(this);"),
										RCView::img(array('src'=>'cross.png', 'class'=>'imgfix', 'title'=>$lang['scheduling_57']))
									) .
									(!$longitudinal ? '' :
										RCView::div(array('style'=>'margin-top:4px;'),
											RCView::span(array('style'=>'color:#666;margin-right:6px;'), $lang['data_entry_67']) . 
											RCView::select(array('name'=>'survey_auth_event_id2', 'class'=>'x-form-text x-form-field', 'style'=>'width:280px;padding-right:0;height:22px;'), 
							...
							RCView::tr(array('style'=>($survey_auth_field3 == '' ? 'display:none;' : '')),
								...
								RCView::td(array('valign'=>'top', 'class'=>'data', 'style'=>'padding:6px 10px;'),
									RCView::select(array('name'=>'survey_auth_field3', 'class'=>'survey-login-field x-form-text x-form-field', 'style'=>'width:300px;padding-right:0;height:22px;'), 
									...
									(!$longitudinal ? '' :
										RCView::div(array('style'=>'margin-top:4px;'),
											RCView::span(array('style'=>'color:#666;margin-right:6px;'), $lang['data_entry_67']) . 
											RCView::select(array('name'=>'survey_auth_event_id3', 'class'=>'x-form-text x-form-field', 'style'=>'width:280px;padding-right:0;height:22px;'), 
												$rc_events, $survey_auth_event_id1, 200)
										)
									)
								)
							...
							RCView::tr(array(),
								...
								RCView::td(array('valign'=>'top', 'class'=>'data', 'style'=>'padding:6px 10px;'),
									RCView::select(array('name'=>'survey_auth_min_fields', 'class'=>'x-form-text x-form-field', 'style'=>'padding-right:0;height:22px;'), 
							...
							RCView::tr(array(),
								...
								RCView::td(array('valign'=>'top', 'class'=>'data', 'style'=>'padding:6px 10px;'),
									RCView::select(array('name'=>'survey_auth_apply_all_surveys', 'class'=>'x-form-text x-form-field', 'style'=>'width:300px;padding-right:0;height:22px;'), 
	...
	// Output JSON
	print json_encode(array('content'=>$content, 'save_btn'=>$lang['designate_forms_13'], 'cancel_btn'=>$lang['global_53'],
...
elseif (isset($_POST['action']) && $_POST['action'] == 'save')
{
	...
	if ($_POST['survey_auth_field1'] != '' && $_POST['survey_auth_field1'] == $_POST['survey_auth_field2']) {
		$_POST['survey_auth_field1'] = $_POST['survey_auth_field2'];
		$_POST['survey_auth_field2'] = '';
	}
	if ($_POST['survey_auth_field1'] != '' && $_POST['survey_auth_field1'] == $_POST['survey_auth_field3']) {
		$_POST['survey_auth_field1'] = $_POST['survey_auth_field3'];
		$_POST['survey_auth_field3'] = '';
	}
	if ($_POST['survey_auth_field2'] != '' && $_POST['survey_auth_field2'] == $_POST['survey_auth_field3']) {
	...
	// Log the action
	log_event($sql, "redcap_projects", "MANAGE", $project_id, "project_id = $project_id", "Add/edit survey login settings");
	// Output JSON
	$content = 	RCView::img(array('src'=>'tick.png', 'class'=>'imgfix')) . 
				RCView::span(array('style'=>'color:green;'), $lang['survey_606']);
	print json_encode(array('content'=>$content, 'title'=>$lang['survey_605'], 'login_enabled'=>$_POST['survey_auth_enabled']));
}
