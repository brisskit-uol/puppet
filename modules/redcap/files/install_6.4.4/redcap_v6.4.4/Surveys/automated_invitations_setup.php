...
elseif (isset($_POST['action']) && $_POST['action'] == 'save')
{
	...
	$sql = "insert into redcap_surveys_scheduler 
			...
			reminder_timelag_minutes, reminder_nextday_type, reminder_nexttime, reminder_exact_time, delivery_type
			) 
			values
			...
			delivery_type = ".checkNull($_POST['delivery_type']);
	if (db_query($sql)) 
	{
