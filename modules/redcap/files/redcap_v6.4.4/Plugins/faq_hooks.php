...
<h2 id="WhywouldsomeonebuildaREDCapplugin">Why would someone utilize a REDCap hook?<a class="anchor" href="#WhywouldsomeonebuildaREDCapplugin" title="Link to this section"></a></h2>
<p>
...
<h2 id="WhocanbuildaREDCapplugin">Who can build a REDCap hook?<a class="anchor" href="#WhocanbuildaREDCapplugin" title="Link to this section"></a></h2>
<p>
...
<h2 id="WhocanuseaREDCapplugin">Who can use a REDCap hook?<a class="anchor" href="#WhocanuseaREDCapplugin" title="Link to this section"></a></h2>
<p>
...
<h2 id="WhereshouldmypluginfilesbelocatedontheREDCapwebserver">Where should my Hook Functions file be located on the REDCap web server?<a class="anchor" href="#WhereshouldmypluginfilesbelocatedontheREDCapwebserver" title="Link to this section"></a></h2>
<p>
...
<h2 id="WhatisthepreferredmethodinapluginforqueryingREDCapsdatabasetables">What is the preferred method in a hook for querying REDCap's database tables?<a class="anchor" href="#WhatisthepreferredmethodinapluginforqueryingREDCapsdatabasetables" title="Link to this section"></a></h2>
<p>
...
<h2>Can I share my hook with other REDCap partners?</h2>
<p>
...
<h1 id="HookExamples">Hook Examples</h1>



<h2 style="margin-top:30px;">Example 1: Using the "redcap_survey_page" hook to alter the CSS style of a survey page</h2>
<p>
...
<h2 style="margin-top:30px;">Example 2: Using the "redcap_control_center" hook to add a new menu item to the left-hand menu in the Control Center</h2>
<p>
...
<h2 style="margin-top:30px;">Example 3: Using the "redcap_custom_verify_username" hook to validate LDAP usernames when someone attempts to add
a user to a REDCap project</h2>
<p>
