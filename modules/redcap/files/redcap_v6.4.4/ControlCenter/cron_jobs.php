...
<h3 style="margin-top: 0;"><?php echo RCView::img(array('src'=>'clock_frame.png', 'class'=>'imgfix2')) . $lang['control_center_285'] ?></h3>
...
{ 
	...
	<div class="red" style="font-family:arial;margin:20px 0;">
		...
		<a href="https://iwg.devguard.com/trac/redcap/browser/misc/cron.php?format=raw" style="font-family:arial;"><?php echo $lang['control_center_294'] ?></a>. 
