...
$tabs = array(	"ProjectSetup/index.php"=>"<img src='".APP_PATH_IMAGES."arrow_left.png' class='imgfix'> {$lang['app_17']}",
				"Design/define_events.php".(isset($_GET['arm']) ? "?arm=".getArm() : "")=>"<img src='".APP_PATH_IMAGES."clock_frame.png' class='imgfix'> {$lang['global_16']}",
				"Design/designate_forms.php".(isset($_GET['arm']) ? "?arm=".getArm() : "")=>"<font id='popupTrigger'><img src='".APP_PATH_IMAGES."table_refresh.png' class='imgfix'> {$lang['global_28']}</font>" );
renderTabs($tabs);
