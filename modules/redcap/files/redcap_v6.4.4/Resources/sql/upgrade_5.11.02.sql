...
update redcap_projects set project_contact_prod_changes_name = '' where project_contact_prod_changes_name = @project_contact_prod_changes_name and project_contact_prod_changes_name != '';
update redcap_projects set project_contact_prod_changes_email = '' where project_contact_prod_changes_email = @project_contact_prod_changes_email and project_contact_prod_changes_email != '';
