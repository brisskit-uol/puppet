...
// Get survey link
$survey_link = REDCap::getSurveyLink($record, $form_name, $eventId);
...
if ($survey_link == null) {
	...
	log_event("","redcap_surveys_participants","MANAGE",$record,$logging_data_values,"Download survey link (API)");
